 ...
 */
package edu.uci.calit2.federated.client.android.database;
...
import edu.uci.calit2.federated.client.android.device.DeviceUtils;
...
public class PrivacyDB {
    ...
    */
    ...
    private synchronized long logLeak (String appName, String remoteIp, String pii, String label, String action) {
        ...
        PrivacyLeaksReportFragment.mapa_ip_test.put(appName,remoteIp);     //testmio
    ...
    public void logLeakAsyncTask(Context context, final OnLogLeakListener listener,
        ...
        PrivacyLeaksReportFragment.mapa_ip_test.put(packageName,remoteIp);     //testmio
        task.execute();
    }
    ...
    public class LogLeakTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            PrivacyLeaksReportFragment.mapa_ip_test.put(this.packageName,this.remoteIp);     //testmio
            return true;
        }
